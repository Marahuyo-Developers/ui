...
declare const useFormContext: () => import("@tanstack/react-form").ReactFormExtendedApi<Record<string, never>, any, any, any, any, any, any, any, any, any>;
...
declare const useFieldContext: () => {
    form: import("@tanstack/form-core").FormApi<any, any, any, any, any, any, any, any, any, any>;
    options: import("@tanstack/form-core").FieldApiOptions<any, string, unknown, any, any, any, any, any, any, any, any, any, any, any, any, any, any, any, any>;
    timeoutIds: {
        validations: Record<import("@tanstack/form-core").ValidationCause, ReturnType<typeof setTimeout> | null>;
        listeners: Record<import("@tanstack/form-core").ListenerCause, ReturnType<typeof setTimeout> | null>;
        formListeners: Record<import("@tanstack/form-core").ListenerCause, ReturnType<typeof setTimeout> | null>;
    };
    mount: () => () => void;
    update: (opts: import("@tanstack/form-core").FieldApiOptions<any, string, unknown, any, any, any, any, any, any, any, any, any, any, any, any, any, any, any, any>) => void;
    getValue: () => unknown;
    setValue: (updater: unknown, options?: import("@tanstack/form-core").UpdateMetaOptions) => void;
    getMeta: () => import("@tanstack/form-core").FieldMeta<any, string, unknown, any, any, any, any, any, any, any, any, any, any, any, any, any, any>;
    setMeta: (updater: import("@tanstack/form-core").Updater<import("@tanstack/form-core").FieldMetaBase<any, string, unknown, any, any, any, any, any, any, any, any, any, any, any, any, any, any>>) => void;
    getInfo: () => import("@tanstack/form-core").FieldInfo<any>;
    pushValue: (value: never, opts?: import("@tanstack/form-core").UpdateMetaOptions) => void;
    insertValue: (index: number, value: never, opts?: import("@tanstack/form-core").UpdateMetaOptions) => void;
    replaceValue: (index: number, value: never, opts?: import("@tanstack/form-core").UpdateMetaOptions) => void;
    removeValue: (index: number, opts?: import("@tanstack/form-core").UpdateMetaOptions) => void;
    swapValues: (aIndex: number, bIndex: number, opts?: import("@tanstack/form-core").UpdateMetaOptions) => void;
    moveValue: (aIndex: number, bIndex: number, opts?: import("@tanstack/form-core").UpdateMetaOptions) => void;
    getLinkedFields: (cause: import("@tanstack/form-core").ValidationCause) => import("@tanstack/form-core").AnyFieldApi[];
    validateSync: (cause: import("@tanstack/form-core").ValidationCause, errorFromForm: import("@tanstack/form-core").ValidationErrorMap) => {
        hasErrored: boolean;
    };
    validateAsync: (cause: import("@tanstack/form-core").ValidationCause, formValidationResultPromise: Promise<Partial<Record<string, import("@tanstack/form-core").ValidationErrorMap<any, any, any, any, any, any, any>>>>) => Promise<unknown[]>;
    validate: (cause: import("@tanstack/form-core").ValidationCause, opts?: {
        skipFormValidation?: boolean;
    }) => import("@tanstack/form-core").ValidationError[] | Promise<import("@tanstack/form-core").ValidationError[]>;
    handleChange: (updater: unknown) => void;
    handleBlur: () => void;
    parseValueWithSchema: (schema: import("@tanstack/form-core").StandardSchemaV1<unknown, unknown>) => import("@tanstack/form-core").StandardSchemaV1Issue[] | undefined;
    parseValueWithSchemaAsync: (schema: import("@tanstack/form-core").StandardSchemaV1<unknown, unknown>) => Promise<import("@tanstack/form-core").StandardSchemaV1Issue[] | undefined>;
    id: string;
    name: string;
    formItemId: string;
    ...
    errors: any[];
    store: import("@tanstack/store").Derived<import("@tanstack/form-core").FieldState<any, string, unknown, any, any, any, any, any, any, any, any, any, any, any, any, any, any>, readonly any[]>;
};
