...
declare const FileUploadClear: React.ForwardRefExoticComponent<FileUploadClearProps & React.RefAttributes<HTMLButtonElement>>;
declare const FileUpload: React.ForwardRefExoticComponent<FileUploadRootProps & React.RefAttributes<HTMLDivElement>>;
declare const Root: React.ForwardRefExoticComponent<FileUploadRootProps & React.RefAttributes<HTMLDivElement>>;
declare const Trigger: React.ForwardRefExoticComponent<FileUploadTriggerProps & React.RefAttributes<HTMLButtonElement>>;
declare const Dropzone: React.ForwardRefExoticComponent<FileUploadDropzoneProps & React.RefAttributes<HTMLDivElement>>;
declare const List: React.ForwardRefExoticComponent<FileUploadListProps & React.RefAttributes<HTMLDivElement>>;
declare const Item: React.ForwardRefExoticComponent<FileUploadItemProps & React.RefAttributes<HTMLDivElement>>;
declare const ItemPreview: React.ForwardRefExoticComponent<FileUploadItemPreviewProps & React.RefAttributes<HTMLDivElement>>;
declare const ItemMetadata: React.ForwardRefExoticComponent<FileUploadItemMetadataProps & React.RefAttributes<HTMLDivElement>>;
declare const ItemProgress: React.ForwardRefExoticComponent<FileUploadItemProgressProps & React.RefAttributes<HTMLDivElement>>;
declare const ItemDelete: React.ForwardRefExoticComponent<FileUploadItemDeleteProps & React.RefAttributes<HTMLButtonElement>>;
declare const Clear: React.ForwardRefExoticComponent<FileUploadClearProps & React.RefAttributes<HTMLButtonElement>>;
export { FileUpload, FileUploadDropzone, FileUploadTrigger, FileUploadList, FileUploadItem, FileUploadItemPreview, FileUploadItemMetadata, FileUploadItemProgress, FileUploadItemDelete, FileUploadClear, Root, Dropzone, Trigger, List, Item, ItemPreview, ItemMetadata, ItemProgress, ItemDelete, Clear, useStore as useFileUpload, };
