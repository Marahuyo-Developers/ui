...
function Kanban(props) {
  ...
  return _jsx(KanbanContext.Provider, {
    value: contextValue,
...
const KanbanBoard = React.forwardRef((props, forwardedRef) => {
  ...
  return _jsx(KanbanBoardContext.Provider, {
    value: true,
...
const KanbanColumn = React.forwardRef((props, forwardedRef) => {
  ...
  return _jsx(KanbanColumnContext.Provider, {
    value: columnContext,
    children: _jsx(SortableContext, {
      items: items,
      strategy:
...
const KanbanItem = React.forwardRef((props, forwardedRef) => {
  ...
  return _jsx(KanbanItemContext.Provider, {
    value: itemContext,
...
function KanbanOverlay(props) {
  ...
  return ReactDOM.createPortal(
    _jsx(DragOverlay, {
      ...
      ...overlayProps,
      children: _jsx(KanbanOverlayContext.Provider, {
        value: true,
        children:
