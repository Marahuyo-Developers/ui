...
export function DataTableFilterList({ table, debounceMs = DEBOUNCE_MS, throttleMs = THROTTLE_MS, shallow = true, ...props }) {
    ...
    const [joinOperator, setJoinOperator] = useQueryState(JOIN_OPERATOR_KEY, parseAsStringEnum(["and", "or"]).withDefault("and").withOptions({
        clearOnDefault: true,
        shallow,
    }));
