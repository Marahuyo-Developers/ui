...
export function DataTableFilterMenu({ table, debounceMs = DEBOUNCE_MS, throttleMs = THROTTLE_MS, shallow = true, align = 'start', filtersKey = 'filters', openMenuShortcut = 'f', removeFilterShortcuts = ['backspace', 'delete'], ...props }) {
    ...
    }, [inputValue, selectedColumn, removeFilterShortcuts]);
    ...
    }, [open, filters, onFilterRemove, openMenuShortcut]);
...
function DataTableFilterItem({ filter, filterItemId, columns, onFilterUpdate, onFilterRemove, removeFilterShortcuts, }) {
    {
