...
export function DataTablePagination({
  ...
  return _jsxs('div', {
    ...
    children: [
      ...
      _jsxs('div', {
        className:
          'flex flex-col-reverse items-center gap-4 sm:flex-row sm:gap-6 lg:gap-8',
        children: [
          _jsxs('div', {
            ...
            children: [
              ...
              _jsxs(Select, {
                ...
                children: [
                  ...
                  _jsx(SelectContent, {
                    side: 'top',
                    children: pageSizeOptions.map((pageSize) =>
                      _jsx(
                        SelectItem,
