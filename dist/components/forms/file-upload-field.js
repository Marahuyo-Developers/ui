    ...
    children: [
      ...
      _jsxs(FileUpload, {
        ...
        children: [
                ...
                children: [
                  ...
                  _jsxs('p', {
                    ...
                    children: [
                      'Drag & drop',
                      ' ',
                      (fileUploadProps?.maxFiles || 0) > 1 ? 'files' : 'file',
                      ' here',
                    ],
                  }),
                  _jsxs('p', {
          ...
          _jsx(FileUploadList, {
            children: field.state.value.map((file) =>
              _jsxs(
                FileUploadItem,
                {
                  value: file,
                  children: [
                    _jsx(FileUploadItemPreview, {}),
                    _jsx(FileUploadItemMetadata, {}),
                    _jsx(FileUploadItemDelete, {
                      asChild: true,
                      children: _jsx(Button, {
                        variant: 'ghost',
                        size: 'icon',
