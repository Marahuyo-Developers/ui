...
export default function MultiSelectField({ labelProps, containerProps, placeHolder, options, multiSelectProps, }) {
    ...
    return (_jsxs("div", { className: cn('grid w-full items-center gap-2.5', containerProps?.className), ...containerProps, children: [_jsx(Label, { className: "pb-1.5", ...labelProps }), _jsx(MultiSelect, { options: options, value: field.state.value, defaultValue: field.state.value, onValueChange: field.handleChange, placeholder: placeHolder, variant: "default", ...multiSelectProps })] }));
}
